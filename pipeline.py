...
class Summarizer:
        ...
        for jline in tqdm(jsonIn.readlines()):
            ...
            while idx < len(term_with_tag):
                ...
                if idx in start_indices:
                    ...
                    continue
                if len(pos) > 0 and pos[0] in ['N', 'J', 'V']:
    ...
    def rank_phrase_tfidf(self, passage_id):
        ...
        for candidate in phrase_candidates:
            if candidate not in self.document_phrase_cnt['a_' + str(passage_id)]:
                continue
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Summarizer for text summarization.")
    parser.add_argument("--in1", default='/shared/data/qiz3/text_summ/data/nyt13_sample.json', help="Input class number", type=str)
