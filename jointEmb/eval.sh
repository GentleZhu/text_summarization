...
python2 "$root_dir"/src/pred.py --iter=$dump_timer --batch-size=128 --dimensions=100  --graph-name=$network --data-dir="$root_dir"/intermediate_data/ --model-dir="$root_dir"/intermediate_data/model/ \
